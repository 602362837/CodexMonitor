  ...
  return (
    <div className="home-usage">
      <div className="home-section-header">
        <div className="home-section-title">用量快照</div>
      ...
      {showUsageSkeleton ? (
        ...
        <div className="home-usage-empty">
          <div className="home-usage-empty-title">还没有用量数据</div>
          <div className="home-usage-empty-subtitle">
            运行一次 Codex 会话后会开始统计本地用量。
          </div>
          {localUsageError && (
          ...
          <div className="home-usage-models">
            ...
            <div className="home-usage-models-list">
              {localUsageSnapshot?.topModels?.length ? (
                ...
                <span className="home-usage-model-empty">还没有模型</span>
              )}
            </div>
