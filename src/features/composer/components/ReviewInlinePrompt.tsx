...
const PresetStep = memo(function PresetStep({
  ...
  return (
    <div className="review-inline-section">
      ...
      >
        <span className="review-inline-option-title">按 base 分支审核</span>
      ...
      <button
        ...
        disabled={isSubmitting}
      >
        <span className="review-inline-option-title">审核未提交变更</span>
      </button>
      <button
        type="button"
        ...
        disabled={isSubmitting}
      >
        <span className="review-inline-option-title">审核某个提交</span>
      </button>
      <button
        type="button"
        ...
        disabled={isSubmitting}
      >
        <span className="review-inline-option-title">自定义审核说明</span>
      </button>
    </div>
  );
});
...
const BaseBranchStep = memo(function BaseBranchStep({
  ...
  return (
    <div className="review-inline-section">
      ...
      <div className="review-inline-hint">选择一个近期本地分支：</div>
      <div className="review-inline-list" role="listbox" aria-label="Base 分支">
        {reviewPrompt.isLoadingBranches ? (
          <div className="review-inline-empty">正在加载分支…</div>
        ) : branches.length === 0 ? (
          <div className="review-inline-empty">没有找到分支。</div>
        ) : (
...
const CommitStep = memo(function CommitStep({
  ...
  return (
    <div className="review-inline-section">
      ...
      <div className="review-inline-hint">选择一个近期提交：</div>
      <div className="review-inline-list" role="listbox" aria-label="提交">
        {reviewPrompt.isLoadingCommits ? (
          ...
          <div className="review-inline-empty">没有找到提交。</div>
        ) : (
