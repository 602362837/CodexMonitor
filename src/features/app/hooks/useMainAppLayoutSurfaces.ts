...
function buildPrimarySurface({
  ...
  return {
    sidebarProps: {
      ...
      onRenameWorkspaceDisplayName: sidebarHandlers.onRenameWorkspaceDisplayName,
      onSelectThread: sidebarHandlers.onSelectThread,
      onDeleteThread: sidebarHandlers.onDeleteThread,
      onArchiveWorkspaceThreads: sidebarHandlers.onArchiveWorkspaceThreads,
    ...
    homeProps: {
      onAddWorkspace: handleAddWorkspace,
      onAddWorkspaceFromPath: openWorkspaceFromPathPrompt,
